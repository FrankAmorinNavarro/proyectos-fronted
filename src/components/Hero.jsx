        ...
        <>
            <section className="container container-hero py-5 mt-5">
                <div className="row content">
                    <div className="presentation animar col-md-7">
                        ...
                        <span className='intro'>
                            <p className="textt">Creando sitios web, funcionales y fáciles de usar.</p>
                        </span>

                        <div className='btn-grup'>
                            <button className="btn-project me-2" onClick={() => { window.location.href = "#proyectos"; }} >Proyectos</button>
                            <button className="btn-contac" onClick={() => {
                                const ancho = 600;   
                                const alto = 400;    
                                ...
                                window.open(
                                    "https://mail.google.com/mail/?view=cm&fs=1&to=frankalexisamorinnavarro@gmail.com&su=Hola, que tal!&body=Quiero%20enviarte un mensaje...",
                                    "popupCorreo",
                    ...
                    <div className="orbits animar col-md-5" >
                        <canvas
                            ref={canvasRef}
                            width={400}
                            height={400}
